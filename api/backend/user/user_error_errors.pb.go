...
func IsLoginFailed(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == UserServiceErrorReason_LOGIN_FAILED.String() && e.Code == 400
}

func ErrorLoginFailed(format string, args ...interface{}) *errors.Error {
	return errors.New(400, UserServiceErrorReason_LOGIN_FAILED.String(), fmt.Sprintf(format, args...))
}
...
func IsRegisterFailed(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == UserServiceErrorReason_REGISTER_FAILED.String() && e.Code == 400
}

func ErrorRegisterFailed(format string, args ...interface{}) *errors.Error {
	return errors.New(400, UserServiceErrorReason_REGISTER_FAILED.String(), fmt.Sprintf(format, args...))
}
