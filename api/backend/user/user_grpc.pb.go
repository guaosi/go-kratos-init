...
type UserClient interface {
	...
	GetUserByPhone(ctx context.Context, in *GetUserByPhoneReq, opts ...grpc.CallOption) (*GetUserByPhoneReply, error)
}
...
func (c *userClient) VerifyPassword(ctx context.Context, in *VerifyPasswordReq, opts ...grpc.CallOption) (*VerifyPasswordReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.user.User/VerifyPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserByPhone(ctx context.Context, in *GetUserByPhoneReq, opts ...grpc.CallOption) (*GetUserByPhoneReply, error) {
	out := new(GetUserByPhoneReply)
	err := c.cc.Invoke(ctx, "/api.user.User/GetUserByPhone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetUserByPhone(context.Context, *GetUserByPhoneReq) (*GetUserByPhoneReply, error)
...
func (UnimplementedUserServer) GetUserByPhone(context.Context, *GetUserByPhoneReq) (*GetUserByPhoneReply, error) {
...
func _User_VerifyPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.User/VerifyPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_GetUserByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.User/GetUserByPhone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
