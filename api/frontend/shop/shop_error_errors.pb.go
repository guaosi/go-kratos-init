...
func IsLoginFailed(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ShopAdminErrorReason_LOGIN_FAILED.String() && e.Code == 500
}

func ErrorLoginFailed(format string, args ...interface{}) *errors.Error {
	return errors.New(500, ShopAdminErrorReason_LOGIN_FAILED.String(), fmt.Sprintf(format, args...))
}
